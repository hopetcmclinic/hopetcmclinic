TRANSLATIONS = {
    'en': {
        ...
        'nav': {
            ...
            'treatments_dropdown': [
                ...
                {'name': 'Facial Acupuncture', 'link': '/treatments/facial-rejuvenation-acupuncture.html'},
                ...
                {'name': 'Gua Sha', 'link': '/treatments/gua-sha.html'}
            ]
        },
        'footer': {
    ...
    'cn': {
        'meta': {
            ...
            'twitter_card': 'summary_large_image',
            'keywords': '針灸, 美容針灸, 中醫, 新西敏, 拔罐, 艾灸, 刮痧, 中草藥'
        },
        'nav': {
            'home': '首頁', 
            'therapists': '醫師',
            ...
            'lang_link_prefix': '',
            'treatments_dropdown': [
                {'name': '針灸', 'link': '/cn/treatments/acupuncture.html'},
                {'name': '美容針灸', 'link': '/cn/treatments/facial-rejuvenation-acupuncture.html'},
                {'name': '中藥方劑', 'link': '/cn/treatments/herbal-formulas.html'},
                {'name': '拔罐', 'link': '/cn/treatments/cupping.html'},
                {'name': '艾灸', 'link': '/cn/treatments/moxibustion.html'},
                {'name': '刮痧', 'link': '/cn/treatments/gua-sha.html'}
            ]
        },
        'footer': {
            'address': '235-889 Carnarvon St, Buzzer 235, New Westminster, BC V3M1G2',
