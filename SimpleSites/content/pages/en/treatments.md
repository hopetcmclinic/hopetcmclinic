...
description: We offer wide range of traditional chinese medicine treatments, including acupuncture, cupping, moxibustion, guasha, and herbal medicine.
...
core_treatments:
  ...
  acupuncture:
    ...
    techniques:
      - name: "Spirit of Acupuncture (针灵)"
        desc: "Adjusting superficial Wei Qi using individualized pulse characteristics."
  ...
  specialized:
    ...
    facial:
      ...
      desc: "Holistic cosmetic treatment stimulated collagen and improved skin elasticity."
      link: "/blogs/facial-rejuvenation-acupuncture.html"
    auricular:
      title: "Auricular Acupuncture"
      desc: "Needle-free option using ear seeds, suitable for children and sensitive adults."
  complementary:
...
faq:
  ...
  entries:
    - q: "How to prepare for my first visit?"
      a: "Please complete online forms beforehand (approx. 20 mins). Have a light meal 1–2 hours prior and avoid coffee/stimulants."
    - q: "How many treatments will I need?"
      a: "It varies by condition. Acute issues may resolve quickly, while chronic conditions often require ongoing care for reliable results."
    - q: "Are there side effects?"
      a: "Most feel deep calm or relaxation. Some may feel energized. We recommend resting for the remainder of the day."
book:
