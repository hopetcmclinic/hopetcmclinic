---
title: 新西敏针灸、中药、拔罐、刮痧及中医治疗
description: 我们提供广泛的传统中医治疗，包括针灸、美容针灸、拔罐、刮痧、艾灸和中草药。
template: pages/treatments.html
intro:
  title: "整体治疗服务"
  desc: "针灸是一种恢复平衡与健康的整体疗法。每次治疗都是量身定制，从全面诊断开始，运用有效技术解决您的具体需求。"
diagnosis:
  title: "诊断与评估"
...
after_treatment:
  ...
  steps:
    - title: "保持水分"
      desc: "喝温水，帮助身体排出治疗期间释放的毒素。"
      icon: "fas fa-glass-water"
    - title: "休息放松"
      desc: "避免剧烈运动。给身体时间整合疗愈效果。"
      icon: "fas fa-bed"
    - title: "注意保暖"
      desc: "防风防寒，特别是在艾灸、拔罐或刮痧之后。"
...
faq:
  ...
  entries:
    - q: "首次就诊如何准备？"
      a: "请提前完成在线表格（约需 10 分钟）。就诊前 1-2 小时进食清淡，避免咖啡/兴奋剂。"
    - q: "我需要多少次治疗？"
